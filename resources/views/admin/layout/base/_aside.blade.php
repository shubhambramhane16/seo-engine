...
@endphp
     ...
     @if  (isset($systemRolesArray['page'])) @if  ($systemRolesArray['page']!=0)
                <li class="menu-item menu-item-submenu   @yield('pagemaster')" aria-haspopup="true"
                    data-menu-toggle="hover">
                    <a href="{{ url('/admin/page/list') }}" class="menu-link menu-toggle">
                        <span class="svg-icon menu-icon">
                ...
                @endif    @endif
                @if  (isset($systemRolesArray['categories']) || isset($systemRolesArray['items']))  @if  (($systemRolesArray['categories'])!=0 || ($systemRolesArray['items'])!=0)
                <li class="menu-item menu-item-submenu @yield('itemsmaster') @yield('categorymaster')  @yield('packagemaster')"
                ...
                @if  ($systemRolesArray['categories']!=0)
                            <li class="menu-item @yield('itemsmaster')" aria-haspopup="true" data-menu-toggle="hover">
                ...
                @endif
                @if  ($systemRolesArray['items']!=0)
                            <li class="menu-item menu-item-submenu @yield('packagemaster')" aria-haspopup="true"
                                data-menu-toggle="hover">
                                <a href="{{ url('/admin/items/list') }}" class="menu-link menu-toggle">
                                    <i class="menu-bullet menu-bullet-line"><span></span></i>
                ...
                @if  ($systemRolesArray['state']!=0)

                            <li class="menu-item @yield('statemaster')" aria-haspopup="true" data-menu-toggle="hover">
                                <a href="{{ url('/admin/state/list') }}" class="menu-link menu-toggle">
                                    <i class="menu-bullet menu-bullet-line"><span></span></i>
                ...
                @if  (isset($systemRolesArray['centres']))  @if  ($systemRolesArray['centres']!=0)
                <li class="menu-item menu-item-submenu   @yield('centermaster')" aria-haspopup="true"
                    data-menu-toggle="hover">
                ...
                @if  (isset($systemRolesArray['enquires']))  @if  ($systemRolesArray['enquires']!=0)
                <li class="menu-item menu-item-submenu   @yield('enquiry-master')" aria-haspopup="true"
                    data-menu-toggle="hover">
                    <a href="{{ url('/admin/enquiry/list') }}" class="menu-link menu-toggle">
                        <span class="svg-icon menu-icon">
                ...
                @if  (isset($systemRolesArray['testimonials']))
                @if  ($systemRolesArray['testimonials']!=0)
                <li class="menu-item menu-item-submenu   @yield('testimonial_master')" aria-haspopup="true"
                    data-menu-toggle="hover">
    ...
    C303.656,425.9,303.646,343.679,280.428,334.444z" />
                ...
                @if  (isset($systemRolesArray['templates']))
                @if  ($systemRolesArray['templates']!=0)
                <li class="menu-item menu-item-submenu   @yield('templatesmaster')" aria-haspopup="true"
                    data-menu-toggle="hover">
                    <a href="{{ url('/admin/templates/list') }}" class="menu-link menu-toggle">
                        <span class="svg-icon menu-icon">
                            <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <defs></defs>
                ...
                <li class="menu-item menu-item-submenu   @yield('rulemaster')" aria-haspopup="true"
                    ...
                    @endif
                @endif
                @if  (isset($systemRolesArray['users']) || isset($systemRolesArray['roles']))
                      @if  (($systemRolesArray['users'])!=0 || ($systemRolesArray['roles'])!=0)
                <li class="menu-item menu-item-submenu @yield('userlist')" aria-haspopup="true"
                    data-menu-toggle="hover">
                    <a href="#" class="menu-link menu-toggle">
                        <span class="svg-icon menu-icon">
