<script>
let city_id = "{{$locality->city_id ?? ''}}"
let state_id = "{{$locality->state_id ?? ''}}"
</script>
                        ...
                        <div class="row align-items-center">
                            ...
                            <!-- <div class="form-group col-md-12">
                                ...
                                <select name="state_id" class="form-control" id="state" isrequired="isrequired">
                                    ...
                                    <option value="{{$list->id}}" {{runTimeSelection($list->id,$locality->state_id)}}>{{$list->name}}</option>
                                    @endforeach
                                    @endif
                                </select>
                            </div>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <div><input type="text" name="name" placeholder="Enter Locality Name" class="form-control" value="{{$locality->name ?? ""}}" isrequired="isrequired"></div>
                            </div>
                            <div class="form-group col-md-12">
                                <label>Description</label>
                                <textarea name="description" id="" placeholder="Enter Description" class="form-control" cols="30" rows="10">{{$locality->description ?? ""}}</textarea>
                            </div>
                            <div class="form-group col-md-12">
