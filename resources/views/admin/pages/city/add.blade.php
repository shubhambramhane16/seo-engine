                        ...
                        <div class="row align-items-center">
                            <div class="form-group col-md-12">
                                ...
                                <select name="state_id" class="form-control" isrequired="isrequired">
                                    ...
                                    <option value="{{$list->id}},{{$list->name}}" {{runTimeSelection($list->id,old('state_id'))}}>{{$list->name}}</option>
                                    @endforeach
                                    @endif
                                </select>
                            </div>
                            <div class="form-group col-md-12">
                                <label>City</label>
                                <div><input type="text" name="name" placeholder="Enter City Name" class="form-control" isrequired="isrequired" value="{{old('name')}}"></div>
                            </div>
                            <div class="form-group col-md-12">
                            ...
                            <div class="form-group col-md-12">
                                <label>Local Schema Markup</label>

                                <textarea class="form-control" name="local_schema_markup">{{old('local_schema_markup')}}</textarea>
