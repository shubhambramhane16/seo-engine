                    ...
                    <div class="col-lg-12">
                        <div class="row align-items-center">
                            ...
                            <div class="form-group col-md-12 mb-0">
                                <h5 class="mb-0">Import City</h5>
                                <hr>
                            </div>
                            <div class="form-group col-md-12 mb-0">
                                <a href="{{url('/')}}/public/uploads/excel_samples/city_sample.csv" class="float-right btn-sm btn btn-info" target="_blank" style="position: absolute;right: 20px;">Download Import Sample</a>
                            </div>
