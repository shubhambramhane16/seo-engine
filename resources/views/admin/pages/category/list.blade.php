...
<div class="card card-custom">
    <div class="card-header flex-wrap border-0 pt-3 pb-0">
        ...
        <div class="card-toolbar">
            ...
            <!--begin::Button-->
            <a href="{{url('/admin/categories/import')}}" class="btn btn-light-primary font-weight-bolder">
            ...
            &nbsp;
            <a href="{{url('/admin/categories/sync')}}" class="btn btn-primary font-weight-bolder">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{url('/admin/subcategories/list/'.$value->id)}}" class="btn btn-sm btn-clean btn-icon" data-toggle="tooltip" title="View sub categories">
                            <i class="la la-eye"></i>
                        </a>
                    </td>
                </tr>
