...
<div class="card card-custom">
    <div class="card-header flex-wrap border-0 pt-3 pb-0">
        ...
        <div class="card-toolbar">
            ...
            <!--begin::Button-->
            <a href="{{url('/admin/items/import')}}" class="btn btn-light-primary font-weight-bolder">
            ...
            &nbsp;
            <a href="{{url('/admin/items/sync')}}" class="btn btn-primary font-weight-bolder">
                <i class="la la-sync"></i>Sync</a>
            &nbsp;
            <!--begin::Button-->
            <a href="{{url('/admin/items/add')}}" class="btn btn-primary font-weight-bolder">
        ...
        <form action="" method="get" class="w-100">
            <div class="row col-lg-12 pl-0 pr-0">
                ...
                <div class="col-sm-1">
                    <div class="dataTables_length">
                        <label cla>&#160; </label>
                        <a href="{{url('/').'/admin/items/list'}}" class="btn btn-default mt-7" data-toggle="tooltip" title="Reset Filter">Reset</a>
                    </div>
                </div>
            </div>
        </form>
        ...
        <table class="table table-bordered table-hover" id="myTable">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{$value->slug }}</td>
                    <td>
                        <a href="javascript:void(0)" data-url="{{url('admin/items/update-status/'.$value->id.'/'.$value->status)}}" onclick="changeStatus(this)"> <span class="label label-lg font-weight-bold label-light-{{($value->status == 1) ? 'success' : 'danger'}} label-inline">{{($value->status == 1) ? 'Active' : 'InActive'}}</span></a>
                    </td>
                    <td>
                        <a href="{{url('/admin/items/edit/'.$value->id)}}" class="btn btn-sm btn-clean btn-icon" title="Edit details" data-toggle="tooltip">
                            <i class="la la-edit"></i>
                        </a>
                        <a href="javascript:void(0)" data-url="{{url('/admin/items/delete/'.$value->id)}}" class="btn btn-sm btn-clean btn-icon" data-toggle="tooltip" title="Delete" onclick="deleteItem(this)">
