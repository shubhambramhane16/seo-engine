                        ...
                        <div class="row align-items-center">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div>
                                            <select name="centre_type" class="form-control" isrequired="required">
                                                ...
                                                <option value="1" {{runTimeSelection(1,$details->centre_type)}}>Collection Centre</option>
                                                <option value="2" {{runTimeSelection(2,$details->centre_type)}}>Laboratory</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group col-md-4 ">
                                ...
                                <div class="_update_img_action">
                                    ...
                                    @if(str_contains($contract_document['contract_document'],'AWS'))
                                    <a target="_black" href="{{Storage::disk('s3')->url($contract_document['contract_document'])}}" class="btn btn-success btn-sm">View</a> &nbsp;
                                    @else
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <div class="_update_img_action">
                                    ...
                                    <div class="_icon_display">
                                        ...
                                        @if(str_contains($centre_image,'AWS'))
                                        <img src="{{Storage::disk('s3')->url($centre_image)}}" />
                                        @else
