...
<div class="card card-custom">
    <div class="card-header flex-wrap border-0 pt-3 pb-0">
        ...
        <div class="card-toolbar">
            ...
            <!--begin::Button-->
            <a href="{{url('/admin/centres/import')}}" class="btn btn-light-primary font-weight-bolder">
            ...
            &nbsp;
            <a href="{{url('/admin/centres/sync')}}" class="btn btn-primary font-weight-bolder">
        ...
        <table class="table table-bordered table-hover" id="myTable">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{($value->centre_type == 1) ? 'Collection Centre' : 'Laboratory' }}</td>
                    <td>{{$value->slug }}</td>
