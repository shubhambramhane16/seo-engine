                    ...
                    <div class="col-lg-9 col-xl-12">
                        <div class="row align-items-center">
                            <div class="form-group col-md-12">
                                ...
                                <div><input type="text" name="category_name" value="<?php echo e($details->category_name); ?>" class="form-control" placeholder="Enter Category Name" isrequired="isrequired"></div>
                            </div>
                            <div class="form-group col-md-12">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <div class="_update_img_action">
                                    ...
                                    <div class="_icon_display">
                                        ...
                                        <?php else: ?>
                                        <img src="<?php echo e(asset('uploads/category/icons/'.$details->category_icon)); ?>" />
                                        <?php endif; ?>
                                    </div>
                                </div>
                                <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\seo_engine\resources\views/admin/pages/category/edit.blade.php ENDPATH**/ ?>