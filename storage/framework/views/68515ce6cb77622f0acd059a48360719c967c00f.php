                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control" name="reporting_manager_id">
                                    ...
                                    <option value="<?php echo e($approver->id); ?>" <?php echo e(runTimeSelection(old('reporting_manager_id', optional($details->approvalHierarchy)->manager_id),$approver->id)); ?>><?php echo e($approver->name); ?> (<?php echo e($approver->email); ?>)</option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control" name="admin_approver_id">
                                    ...
                                    <?php $__currentLoopData = $approvers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $approver): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($approver->id); ?>" <?php echo e(runTimeSelection(old('admin_approver_id', optional($details->approvalHierarchy)->admin_id),$approver->id)); ?>><?php echo e($approver->name); ?> (<?php echo e($approver->email); ?>)</option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            <?php endif; ?>
...
<?php echo $__env->make('admin.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\sumeshwar sir plans\seo-engine\resources\views/admin/pages/users/edit.blade.php ENDPATH**/ ?>