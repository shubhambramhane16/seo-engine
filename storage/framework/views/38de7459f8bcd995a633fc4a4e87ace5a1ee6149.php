...
<?php $__env->startSection('citymaster','active menu-item-open'); ?>
...
<div class="card card-custom">
    <div class="card-header flex-wrap border-0 pt-3 pb-0">
        ...
        <div class="card-toolbar">
            ...
            <!--begin::Button-->
            <a href="<?php echo e(url('/admin/city/import')); ?>" class="btn btn-light-primary font-weight-bolder">
            ...
            &nbsp;
            <a href="<?php echo e(url('/admin/city/sync')); ?>" class="btn btn-primary font-weight-bolder">
                <i class="la la-sync"></i>Sync</a>
            &nbsp;
            <a href="<?php echo e(url('/admin/city/add')); ?>" class="btn btn-primary font-weight-bolder">
        ...
        <table class="table table-bordered table-hover" id="myTable">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="javascript:void(0)" data-url="<?php echo e(url('admin/city/update-status/'.$value->id.'/'.$value->status)); ?>" onclick="changeStatus(this)"> <span class="label label-lg font-weight-bold label-light-<?php echo e(($value->status == 1) ? 'success' : 'danger'); ?> label-inline"><?php echo e(($value->status == 1) ? 'Active' : 'InActive'); ?></span></a>
                    </td>
                    <td>
                        <a href="<?php echo e(url('/admin/city/edit/'.$value->id)); ?>" class="btn btn-sm btn-clean btn-icon" title="Edit details" data-toggle="tooltip"> <i class="la la-edit"></i> </a>
                        <a href="<?php echo e(url('/admin/city/'.$value->id.'/locality/'.$value->state?->id)); ?>" class="btn btn-sm btn-primary" title="View Localities" >View Localities</a>
                    </td>
                </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php endif; ?>
...
<?php echo $__env->make('admin.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\seo_engine\resources\views/admin/pages/city/list.blade.php ENDPATH**/ ?>